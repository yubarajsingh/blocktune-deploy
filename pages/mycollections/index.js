...
<div className=" py-3 bg-gray-700  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
    ...
    <div class="px-5 pb-2">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="#" class="text-white bg-blue-200 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sell </a>
        </div>
</div>
            </div>
        </div>
