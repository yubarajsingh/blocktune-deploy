...
<main class="grid place-items-center min-h-screen bg-gradient-to-t from-blue-200 to-indigo-900 p-5">
  <div>
    <h1 class="text-4xl sm:text-5xl md:text-7xl font-bold text-gray-200 mb-5">Music made for you</h1>
    <section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <div class="bg-gray-900 shadow-lg rounded p-3">
        ...
        <div class="p-5">
          <h3 class="text-white text-lg">Kesariya tera </h3>
          <p class="text-gray-400">Arjit singh </p>
        </div>
      </div>
      ...
      <div class="bg-gray-900 shadow-lg rounded p-3">
        ...
        <div class="p-5">
          <h3 class="text-white text-lg">Pillowtalk</h3>
          <p class="text-gray-400">Zayn malik</p>
        </div>
      </div>
      ...
      <div class="bg-gray-900 shadow-lg rounded p-3">
        ...
        <div class="p-5">
          <h3 class="text-white text-lg">Beautiful People</h3>
          <p class="text-gray-400">Ed Sheeran</p>
        </div>
      </div>
      ...
      <div class="bg-gray-900 shadow-lg rounded p-3">
        ...
        <div class="p-5">
          <h3 class="text-white text-lg">jeene laga hoon</h3>
          <p class="text-gray-400">Atif Aslam</p>
        </div>
      </div>
      ...
      <div class="bg-gray-900 shadow-lg rounded p-3">
        ...
        <div class="p-5">
          <h3 class="text-white text-lg">Perfect</h3>
          <p class="text-gray-400">Ed Sheeran</p>
        </div>
      </div>
